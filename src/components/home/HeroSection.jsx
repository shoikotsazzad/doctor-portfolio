        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex items-center justify-center border border-teal-600 text-teal-600 hover:bg-teal-50 text-base px-8 py-3 rounded-lg bg-transparent transition-colors duration-200">
                View Credentials
              </button>
            </div>
